/*
 * $Id: Utils.h 74 2007-10-20 10:46:39Z soarchin $
...
extern DWORD ColorStrToPixel(CONST CHAR * str);
extern CHAR * StrProcessLine(CHAR *& str);
extern CONST CHAR * GetFileExt(CONST CHAR * filename);
