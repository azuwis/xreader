...
const char *hash_insert(table, key, value)
struct hash_control *table;
const char *key;
PTR value;
{
...
const char *hash_jam(table, key, value)
struct hash_control *table;
const char *key;
PTR value;
{
...
PTR hash_replace(table, key, value)
struct hash_control *table;
const char *key;
PTR value;
{
...
void hash_print_statistics(f, name, table)
