...
//
//    $Id: player.h 64 2008-02-27 17:32:07Z hrimfaxi $
//
...
/// Music Plugin Framework
typedef struct _MusicDriver
{
	void (*initFunct) (int);
	int (*loadFunct) (char *);
	int (*playFunct) ();
	...
	void (*backwardSeekFunct) (float seconds);
	void (*forwardSeekFunct) (float seconds);
	 mad_timer_t(*getTimer) (void);
...
extern void MusicDriver_initial(int);
extern int MusicDriver_load(char *);
extern int MusicDriver_play();
extern void MusicDriver_pause();
extern void MusicDriver_end();
extern void MusicDriver_setVolumeBoostType(char *);
extern void MusicDriver_setVolumeBoost(int);
extern struct fileInfo MusicDriver_getInfo();
extern struct fileInfo MusicDriver_getTagInfo();
extern void MusicDriver_getTimeString();
extern int MusicDriver_getPercentage();
extern int MusicDriver_getPlayingSpeed();
extern int MusicDriver_setPlayingSpeed(int);
extern int MusicDriver_endOfStream();
extern int MusicDriver_setMute(int);
extern int MusicDriver_setFilter(double[32], int copyFilter);
extern void MusicDriver_enableFilter();
extern void MusicDriver_disableFilter();
extern int MusicDriver_isFilterEnable();
extern int MusicDriver_isFilterSupported();
extern int MusicDriver_suspend();
extern int MusicDriver_resume();
extern void MusicDriver_fadeOut(float seconds);
