	...
	switch ((t_fs_filetype) filelist[selidx].data) {
		case fs_filetype_png:
			switch (where) {
				case scene_in_zip:
					result =
						image_readpng_in_zip(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_chm:
					result =
						image_readpng_in_chm(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_rar:
					result =
						image_readpng_in_rar(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				default:
					result =
						image_readpng(filename, &width, &height, &imgdata,
									  &bgcolor);
					break;
			}
			break;
		case fs_filetype_gif:
			switch (where) {
				case scene_in_zip:
					result =
						image_readgif_in_zip(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_chm:
					result =
						image_readgif_in_chm(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_rar:
					result =
						image_readgif_in_rar(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				default:
					result =
						image_readgif(filename, &width, &height, &imgdata,
									  &bgcolor);
					break;
			}
			break;
		case fs_filetype_jpg:
			switch (where) {
				case scene_in_zip:
					result =
						image_readjpg_in_zip(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_chm:
					result =
						image_readjpg_in_chm(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_rar:
					result =
						image_readjpg_in_rar(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				default:
					{
						result =
							image_readjpg(filename, &width, &height, &imgdata,
										  &bgcolor);
					}
					break;
			}
		...
		case fs_filetype_bmp:
			switch (where) {
				case scene_in_zip:
					result =
						image_readbmp_in_zip(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_chm:
					result =
						image_readbmp_in_chm(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_rar:
					result =
						image_readbmp_in_rar(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				default:
					result =
						image_readbmp(filename, &width, &height, &imgdata,
									  &bgcolor);
					break;
			}
			break;
		case fs_filetype_tga:
			switch (where) {
				case scene_in_zip:
					result =
						image_readtga_in_zip(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_chm:
					result =
						image_readtga_in_chm(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				case scene_in_rar:
					result =
						image_readtga_in_rar(config.shortpath, filename, &width,
											 &height, &imgdata, &bgcolor);
					break;
				default:
					result =
						image_readtga(filename, &width, &height, &imgdata,
									  &bgcolor);
					break;
			}
			break;
