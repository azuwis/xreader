...
typedef unsigned (*TGAfread)(void *buf, unsigned r, unsigned n, void *stream);
typedef int (*TGAfseek)(void *stream, long offset, int origin);
typedef long (*TGAftell)(void *stream);
extern TGAfread tga_fread;
extern TGAfseek tga_fseek;
extern TGAftell tga_ftell;
...
TGA* TGAOpenFd __P((FILE *fd, TGAfread nfread, TGAfseek nfseek, TGAftell nftell));
...
#define TGA_ERROR(tga, code) if(tga) (tga)->last = code
